...
#     border-radius: 18px;
#     color: white;
#     box-shadow: 0px 12px 30px rgba(52,152,219,0.35);
#     margin-bottom: 30px;
# }
...
# /* Header Styling - Exact Gradient from your Image */
# .header-box {
...
# /* Glass Cards Style - As seen in your image */
# .glass-card {
...
# /* Custom Tabs UI - Exact Match to your Button Style */
# button[data-baseweb="tab"] {
...
# /* Selected Tab Style (The Blue Gradient Pill) */
# button[data-baseweb="tab"][aria-selected="true"] {
#     background: linear-gradient(90deg, #6366f1, #06b6d4) !important;
#     color: white !important;
...
# /* Remove the default Streamlit bottom line under tabs */
...
#     """
#     Dynamic bar graph for solar energy efficiency
#     Highlights the selected panel condition
#     """
...
#         eff, _ = get_efficiency(condition)
#         efficiencies.append(eff)

#     fig, ax = plt.subplots(figsize=(4, 3))


#     bars = ax.bar(conditions, efficiencies)

#     # Highlight selected condition
#     for bar, condition in zip(bars, conditions):
#         if condition == selected_state:
#             bar.set_alpha(1.0)
...
#     ax.set_xlabel("Solar Panel Condition")
#     ax.set_ylabel("Efficiency Output (%)")
#     ax.set_title("Solar Energy Efficiency Output Analysis (Dynamic)")
